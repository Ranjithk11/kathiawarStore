...
const StyledAllViewProductCard = styled(Card, {
...
const AllViewProductsCard = ({
  ...
  return (
    <StyledAllViewProductCard enabledMask={enabledMask} minWidth={minWidth}>
      <Box
        component="div"
    ...
    </StyledAllViewProductCard>
  );
};

export default AllViewProductsCard;
